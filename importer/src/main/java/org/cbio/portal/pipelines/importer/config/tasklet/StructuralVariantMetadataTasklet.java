 ...
 * @author ochoaa
 */
public class StructuralVariantMetadataTasklet implements Tasklet {
    ...
    public RepeatStatus execute(StepContribution stepContribution, ChunkContext chunkContext) throws Exception {
        ...
        // load structural variant metadata from datafile
        MultiKeyMap structuralVariantMetadata = DataFileUtils.loadDataFileMetadata(dataFile);
        
        // datafile and structural variant metadata to execution context
        chunkContext.getStepContext().getStepExecution().getJobExecution().getExecutionContext().put("dataFile", dataFile);
        chunkContext.getStepContext().getStepExecution().getJobExecution().getExecutionContext().put("structuralVariantMetadata", structuralVariantMetadata);
